...
--
-- Name: customer_product_aliases; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.customer_product_aliases (
    ...
    alias_key text GENERATED ALWAYS AS (lower(regexp_replace(btrim(COALESCE(customer_item_code, customer_description)), '\s+'::text, ' '::text, 'g'::text))) STORED,
    CONSTRAINT customer_product_aliases_case_size_lb_check CHECK ((case_size_lb > (0)::numeric)),
    CONSTRAINT customer_product_aliases_check CHECK (((customer_item_code IS NOT NULL) OR (customer_description IS NOT NULL)))
);


--
-- Name: customer_product_aliases_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.customer_product_aliases ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.customer_product_aliases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: purchase_documents; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.purchase_documents (
    id integer NOT NULL,
    storage_bucket text DEFAULT 'purchase-documents'::text NOT NULL,
    ...
    created_by text,
    document_kind text DEFAULT 'purchase'::text NOT NULL,
    CONSTRAINT purchase_documents_byte_size_check CHECK ((byte_size > 0)),
    CONSTRAINT purchase_documents_document_kind_check CHECK ((document_kind = ANY (ARRAY['purchase'::text, 'sales'::text]))),
    CONSTRAINT purchase_documents_mime_type_check CHECK ((mime_type = ANY (ARRAY['image/png'::text, 'image/jpeg'::text, 'application/pdf'::text]))),
    CONSTRAINT purchase_documents_status_check CHECK ((status = ANY (ARRAY['uploaded'::text, 'upload_failed'::text, 'extracted'::text, 'extraction_failed'::text, 'approved'::text])))
);


--
-- Name: purchase_documents_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.purchase_documents ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.purchase_documents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.supplier_product_aliases (
    ...
    product_id integer NOT NULL,
    lb_per_unit numeric(14,4),
    unit text,
    created_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    created_by text,
    updated_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    CONSTRAINT supplier_product_aliases_lb_per_unit_check CHECK ((lb_per_unit > (0)::numeric))
);


--
-- Name: supplier_product_aliases_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.supplier_product_aliases ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.supplier_product_aliases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: trace_event_lots; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trace_event_lots (
    id bigint NOT NULL,
    trace_event_id bigint NOT NULL,
    lot_id integer NOT NULL,
    role text NOT NULL,
    quantity_lb numeric(14,4) NOT NULL,
    created_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    created_at_source text DEFAULT 'database'::text NOT NULL,
    CONSTRAINT tel_role_sign CHECK ((((role = ANY (ARRAY['output'::text, 'received'::text])) AND (quantity_lb > (0)::numeric)) OR ((role = ANY (ARRAY['input'::text, 'shipped'::text])) AND (quantity_lb < (0)::numeric)) OR (role = ANY (ARRAY['adjusted'::text, 'moved'::text])))),
    CONSTRAINT trace_event_lots_quantity_lb_check CHECK ((quantity_lb <> (0)::numeric)),
    CONSTRAINT trace_event_lots_role_check CHECK ((role = ANY (ARRAY['input'::text, 'output'::text, 'shipped'::text, 'received'::text, 'adjusted'::text, 'moved'::text])))
);


--
-- Name: trace_event_lots_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.trace_event_lots ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.trace_event_lots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.trace_events (
    ...
    event_type text NOT NULL,
    epcis_type text NOT NULL,
    transaction_id integer NOT NULL,
    correction_id uuid,
    occurred_at timestamp with time zone NOT NULL,
    recorded_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    business_date date NOT NULL,
    late_recorded boolean GENERATED ALWAYS AS (((recorded_at - occurred_at) > '24:00:00'::interval)) STORED,
    biz_location text DEFAULT 'seven-wells-plant'::text NOT NULL,
    source_party text,
    ...
    created_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    created_at_source text DEFAULT 'database'::text NOT NULL,
    CONSTRAINT trace_events_correction_pairing CHECK (((event_type = ANY (ARRAY['void'::text, 'restore'::text, 'amend'::text])) = (correction_id IS NOT NULL))),
    CONSTRAINT trace_events_epcis_type_check CHECK ((epcis_type = ANY (ARRAY['object'::text, 'transformation'::text, 'aggregation'::text]))),
    CONSTRAINT trace_events_event_type_check CHECK ((event_type = ANY (ARRAY['receive'::text, 'make'::text, 'pack'::text, 'ship'::text, 'adjust'::text, 'void'::text, 'restore'::text, 'amend'::text, 'merge'::text])))
);


--
-- Name: trace_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.trace_events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.trace_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: customer_product_aliases customer_product_aliases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_product_aliases
    ADD CONSTRAINT customer_product_aliases_pkey PRIMARY KEY (id);
...
--
-- Name: purchase_documents purchase_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: purchase_documents purchase_documents_storage_path_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchase_documents
    ADD CONSTRAINT purchase_documents_storage_path_key UNIQUE (storage_path);
...
ALTER TABLE ONLY public.supplier_product_aliases
    ADD CONSTRAINT supplier_product_aliases_pkey PRIMARY KEY (id);
...
--
-- Name: trace_event_lots tel_event_lot_role_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_event_lots
    ADD CONSTRAINT tel_event_lot_role_uniq UNIQUE (trace_event_id, lot_id, role);


--
-- Name: trace_event_lots trace_event_lots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_event_lots
    ADD CONSTRAINT trace_event_lots_pkey PRIMARY KEY (id);


--
-- Name: trace_events trace_events_event_uuid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_event_uuid_key UNIQUE (event_uuid);
...
--
-- Name: trace_events trace_events_txn_type_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_txn_type_uniq UNIQUE NULLS NOT DISTINCT (transaction_id, event_type, correction_id);
...
--
-- Name: customer_product_aliases_uidx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_customer_product_aliases_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_customer_product_aliases_desc ON public.customer_product_aliases USING btree (customer_id, lower(regexp_replace(btrim(customer_description), '\s+'::text, ' '::text, 'g'::text))) WHERE (customer_description IS NOT NULL);
...
--
-- Name: idx_expected_receipts_source_doc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_expected_receipts_source_doc ON public.expected_receipts USING btree (source_document_id) WHERE (source_document_id IS NOT NULL);
...
--
-- Name: idx_expected_receipts_supplier_ref; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_expected_receipts_supplier_ref ON public.expected_receipts USING btree (supplier_id, lower(regexp_replace(btrim(reference_number), '\s+'::text, ' '::text, 'g'::text))) WHERE (reference_number IS NOT NULL);
...
--
-- Name: idx_purchase_documents_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_purchase_documents_kind ON public.purchase_documents USING btree (document_kind);


--
-- Name: idx_purchase_documents_sha256; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sales_orders_customer_po; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_orders_customer_po ON public.sales_orders USING btree (customer_id, lower(regexp_replace(btrim(customer_po), '\s+'::text, ' '::text, 'g'::text))) WHERE (customer_po IS NOT NULL);
...
--
-- Name: idx_sales_orders_source_doc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: supplier_product_aliases_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX supplier_product_aliases_uidx ON public.supplier_product_aliases USING btree (supplier_id, lower(regexp_replace(btrim(vendor_description), '\s+'::text, ' '::text, 'g'::text)));
...
CREATE INDEX tel_lot_idx ON public.trace_event_lots USING btree (lot_id);


--
-- Name: tel_lot_role_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tel_lot_role_idx ON public.trace_event_lots USING btree (lot_id, role);


--
-- Name: trace_events_late_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trace_events_late_idx ON public.trace_events USING btree (business_date) WHERE late_recorded;


--
-- Name: trace_events_occurred_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX trace_events_occurred_idx ON public.trace_events USING btree (occurred_at);


--
-- Name: trace_events_txn_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trace_event_lots trg_trace_event_lots_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_trace_event_lots_append_only BEFORE DELETE OR UPDATE ON public.trace_event_lots FOR EACH ROW EXECUTE FUNCTION public.ledger_block_append_only_change();


--
-- Name: trace_event_lots trg_trace_event_lots_created_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_trace_event_lots_created_at BEFORE INSERT OR UPDATE ON public.trace_event_lots FOR EACH ROW EXECUTE FUNCTION public.ledger_enforce_created_at();


--
-- Name: trace_events trg_trace_events_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_trace_events_append_only BEFORE DELETE OR UPDATE ON public.trace_events FOR EACH ROW EXECUTE FUNCTION public.ledger_block_append_only_change();


--
-- Name: trace_events trg_trace_events_created_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_trace_events_created_at BEFORE INSERT OR UPDATE ON public.trace_events FOR EACH ROW EXECUTE FUNCTION public.ledger_enforce_created_at();
...
--
-- Name: customer_product_aliases customer_product_aliases_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_product_aliases
    ADD CONSTRAINT customer_product_aliases_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: customer_product_aliases customer_product_aliases_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: expected_receipts expected_receipts_source_document_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expected_receipts
    ADD CONSTRAINT expected_receipts_source_document_id_fkey FOREIGN KEY (source_document_id) REFERENCES public.purchase_documents(id);
...
ALTER TABLE ONLY public.sales_orders
    ADD CONSTRAINT sales_orders_source_document_id_fkey FOREIGN KEY (source_document_id) REFERENCES public.purchase_documents(id);
...
ALTER TABLE ONLY public.supplier_product_aliases
    ADD CONSTRAINT supplier_product_aliases_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id);


--
-- Name: supplier_product_aliases supplier_product_aliases_supplier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_product_aliases
    ADD CONSTRAINT supplier_product_aliases_supplier_id_fkey FOREIGN KEY (supplier_id) REFERENCES public.suppliers(id);
...
--
-- Name: trace_event_lots trace_event_lots_lot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_event_lots
    ADD CONSTRAINT trace_event_lots_lot_id_fkey FOREIGN KEY (lot_id) REFERENCES public.lots(id);


--
-- Name: trace_event_lots trace_event_lots_trace_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_event_lots
    ADD CONSTRAINT trace_event_lots_trace_event_id_fkey FOREIGN KEY (trace_event_id) REFERENCES public.trace_events(id);


--
-- Name: trace_events trace_events_correction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_correction_id_fkey FOREIGN KEY (correction_id) REFERENCES public.ledger_corrections(id);


--
-- Name: trace_events trace_events_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id);


--
-- Name: trace_events trace_events_sales_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_sales_order_id_fkey FOREIGN KEY (sales_order_id) REFERENCES public.sales_orders(id);


--
-- Name: trace_events trace_events_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trace_events
    ADD CONSTRAINT trace_events_transaction_id_fkey FOREIGN KEY (transaction_id) REFERENCES public.transactions(id);
