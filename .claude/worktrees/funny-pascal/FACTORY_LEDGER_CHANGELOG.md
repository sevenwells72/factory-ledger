...
| 19 | 2026-03-25 | main.py, migration | Fix /receive preview 503 on ambiguous product (re-raise HTTPException); sync has_bom flag on BOM line insert + backfill; rename product 166 "Sweetened Flake Coconut" → "Coconut Sweetened Flake" for natural search | /receive preview returned 503 instead of 400 with disambiguation; product 126 had stale has_bom=false; product 166 couldn't be found by "coconut sweetened flake" | /receive preview reverts to 503 on ambiguous products; new BOM lines don't set has_bom; product 166 search requires exact reversed word order | `main.py`, `migrations/032_backfill_has_bom_and_rename_product_166.sql` |
