...
- **File(s) changed:** `dashboard/dashboard.js`, `dashboard/dashboard.css`, `dashboard/index.html`, `dashboard/process-flow.html`, `main.py`, `tests/test_dashboard_b2.py`, `FACTORY_LEDGER_CHANGELOG.md` (row 69)
