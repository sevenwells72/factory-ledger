...
- STATUS-004/012 versus the requested overdue date tone: Health is explicitly the only alarm. Pending the owner's response, keep overdue date wording muted and leave severity exclusively to the server-provided Health icon. Do not recalculate Health v2.1 in the browser.
